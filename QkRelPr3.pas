...
var
  Qk_RelPro3: TQk_RelPro3;
  x, qtde, ate_3, mais_3, andam     : Integer;

implementation

Uses DMTD, Menu , RelPro3, FuncGeral;

{$R *.DFM}

procedure TQk_RelPro3.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qtde := qtde + 1;
...
procedure TQk_RelPro3.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  x      := 0;
  qtde   := 0;
...
procedure TQk_RelPro3.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin     
  QrLabel3.Caption := '000';  
  qtde := 0;
...
procedure TQk_RelPro3.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
