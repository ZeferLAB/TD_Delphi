...
procedure TF_PCadTab.BitBtn2Click(Sender: TObject);
begin
  Dm.Cad_Tab2.Close;
  Close;
end;

procedure TF_PCadTab.MaskEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then BitBtn1.SetFocus;
end;

procedure TF_PCadTab.FormActivate(Sender: TObject);
begin
  ComboBox1.SetFocus;
end;

procedure TF_PCadTab.ComboBox1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then MaskEdit1.SetFocus;
end;

procedure TF_PCadTab.BitBtn1Click(Sender: TObject);
begin
  ...
  begin
    ...
    Dm.Cad_Tab2.Sql.Add('tabela = ' + Trim(MaskEdit1.Text));
  end;
  ...
  begin
    ...
    Dm.Cad_Tab2.Sql.Add('descricao like ' + Chr(39) + Trim(MaskEdit1.Text) + '%' + Chr(39));
