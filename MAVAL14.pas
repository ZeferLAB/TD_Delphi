...
procedure TF_maval14.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  ...
  Qrlabel46.caption := 'Barueri, ' + dm.arqaux.fieldbyname('data').asString;
  Qrlabel41.caption := dm.arqaux.fieldbyname('cep').asstring + '   ' + dm.arqaux.fieldbyname('cidade').asstring;   // + '   ' + dm.arqaux.fieldbyname('uf').asstring;
  Qrlabel42.caption := dm.arqaux.fieldbyname('bairro').asstring;
  parc1 := Copy(dm.arqaux.fieldbyname('parcelas').asstring,1,3);
  parc1 := parc1 + '/' + Copy(dm.arqaux.fieldbyname('parcelas').asstring,4,3);

  parc2 := Copy(dm.arqaux.fieldbyname('parc2').asstring,1,3);
  parc2 := parc2 + '/' + Copy(dm.arqaux.fieldbyname('parc2').asstring,4,3);

  parc3 := Copy(dm.arqaux.fieldbyname('parc3').asstring,1,3);
  parc3 := parc3 + '/' + Copy(dm.arqaux.fieldbyname('parc3').asstring,4,3);

  parc4 := Copy(dm.arqaux.fieldbyname('parc4').asstring,1,3);
  parc4 := parc4 + '/' + Copy(dm.arqaux.fieldbyname('parc4').asstring,4,3);

  parc5 := Copy(dm.arqaux.fieldbyname('parc5').asstring,1,3);
  parc5 := parc5 + '/' + Copy(dm.arqaux.fieldbyname('parc5').asstring,4,3);

  parc6 := Copy(dm.arqaux.fieldbyname('parc6').asstring,1,3);
  parc6 := parc6 + '/' + Copy(dm.arqaux.fieldbyname('parc6').asstring,4,3);
  ...
  if dm.arqaux.fieldbyname('parcelas').asstring <> '' then
  parcela1 :=  parc1 + StringofChar(' ',38) +  dm.arqaux.fieldbyname('data_ven').asstring + StringofChar(' ',56) + dm.arqaux.fieldbyname('vr_venc').asstring;

  if dm.arqaux.fieldbyname('parc2').asstring <> '' then
  parcela2 :=  parc2  + StringofChar(' ',38) + dm.arqaux.fieldbyname('ven_parc2').asstring + StringofChar(' ',56) + dm.arqaux.fieldbyname('val_parc2').asstring;

  if dm.arqaux.fieldbyname('parc3').asstring <> '' then
  parcela3 :=  parc3  + StringofChar(' ',38) +  dm.arqaux.fieldbyname('ven_parc3').asstring + StringofChar(' ',56) + dm.arqaux.fieldbyname('val_parc3').asstring;

   if dm.arqaux.fieldbyname('parc4').asstring <> '' then
  parcela4 :=  parc3  + StringofChar(' ',38) +  dm.arqaux.fieldbyname('ven_parc4').asstring + StringofChar(' ',56) + dm.arqaux.fieldbyname('val_parc4').asstring;

   if dm.arqaux.fieldbyname('parc5').asstring <> '' then
  parcela5 :=  parc5  + StringofChar(' ',38) +  dm.arqaux.fieldbyname('ven_parc5').asstring + StringofChar(' ',56) + dm.arqaux.fieldbyname('val_parc5').asstring;

  if dm.arqaux.fieldbyname('parc6').asstring <> '' then
  parcela6 :=  parc6  + StringofChar(' ',38) + dm.arqaux.fieldbyname('ven_parc6').asstring + StringofChar(' ',56) + dm.arqaux.fieldbyname('val_parc6').asstring;

  DM.ArqAux1.Close;
  DM.ArqAux1.Sql.Clear;
  DM.ArqAux1.Sql.Add('select * from ' + Uppercase(F_menu.label1.caption + 'NOTI where nome = ' + Chr(39) + dm.arqaux.fieldbyname('nome').asString + Chr(39)));
  DM.ArqAux1.Open;
  ...
  Begin
   ...
   Begin
    if parcela1 <> '' then
     QRMemo1.Lines.Add(parcela1);
     if parcela2 <> '' then
     QRMemo1.Lines.Add(parcela2);
     if parcela3 <> '' then
     QRMemo1.Lines.Add(parcela3);
     if parcela4 <> '' then
     QRMemo1.Lines.Add(parcela4);
     if parcela5 <> '' then
     QRMemo1.Lines.Add(parcela5);
     if parcela6 <> '' then
     QRMemo1.Lines.Add(parcela6);
     DM.ArqAux1.next;
   end;
  end;
  //data_ven = venc_parc
...
procedure TF_maval14.QRChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
