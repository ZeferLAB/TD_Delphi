...
procedure TF_Maval25.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  ...
  //Imagem Dibens
  if (Copy(Dm.ArqAux.FieldByName('arquivo').asString, 1,3) = 'DIB') then
  begin
  ...
  else if (Copy(Dm.ArqAux.FieldByName('arquivo').asString, 1,3) = 'UNI') then
  begin
...
procedure TF_Maval25.QRChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
