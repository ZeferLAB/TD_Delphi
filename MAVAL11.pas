...
procedure TF_maval11.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin

  Qrlabel35.caption := dm.arqaux.fieldbyname('endereco').asstring + ' - ' + dm.arqaux.fieldbyname('bairro').asstring;
  ...
  Qrlabel46.caption := formatdatetime('"Rio de Janeiro," dd "de" mmmm "de" yyyy', dm.arqaux.fieldbyname('data').asDateTime);
...
procedure TF_maval11.QRChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
