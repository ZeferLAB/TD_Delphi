...
procedure TF_PFer.BitBtn2Click(Sender: TObject);
begin
  Dm.Feriados.Close;
  Close;
end;

procedure TF_PFer.MaskEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then BitBtn1.SetFocus;
end;

procedure TF_PFer.FormActivate(Sender: TObject);
begin
  ComboBox1.SetFocus;
end;

procedure TF_PFer.ComboBox1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then MaskEdit1.SetFocus;
end;

procedure TF_PFer.BitBtn1Click(Sender: TObject);
begin
  ...
  begin
    ...
    Dm.Feriados.Sql.Add('descricao like ' + Chr(39) + Trim(MaskEdit1.Text) + '%' + Chr(39));
    Dm.Feriados.Sql.Add('ORDER BY descricao');
  end;  
  Dm.Feriados.Open;
...
procedure TF_PFer.ComboBox1Exit(Sender: TObject);
begin
