...
var
  Qk_RelPro: TQk_RelPro;
  x, qtde, ate_3, mais_3, andam     : Integer;

implementation

Uses DMTD, Menu , RelPro, FuncGeral;

{$R *.DFM}

procedure TQk_RelPro.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qtde := qtde + 1;
...
procedure TQk_RelPro.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  x      := 0;
  qtde   := 0;
...
procedure TQk_RelPro.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin     
  QrLabel3.Caption := '000';  
 // qtde := 0;
...
procedure TQk_RelPro.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
