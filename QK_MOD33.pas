...
procedure TF_Mod33.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TF_Mod33.QRChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
 ...
 // QrLabel11.Caption := 'CNPJ/CPF:' + Table1.FieldByName('documento').asString;
  ...
  QrLabel22.caption  := Table1.FieldByName('banco').asstring;
  QrLabel23.caption  := Table1.FieldByName('contrato').asstring;
