...
procedure TF_PesqEsc.BitBtn2Click(Sender: TObject);
begin
  Dm.Escrit.Close;
  Close;
end;

procedure TF_PesqEsc.MaskEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then BitBtn1.SetFocus;
end;

procedure TF_PesqEsc.FormActivate(Sender: TObject);
begin
  ComboBox1.SetFocus;
end;

procedure TF_PesqEsc.ComboBox1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then MaskEdit1.SetFocus;
end;

procedure TF_PesqEsc.BitBtn1Click(Sender: TObject);
begin
  ...
  begin
    ...
    Dm.Escrit.Sql.Add('codigo = ' + Trim(MaskEdit1.Text));
  end;
  ...
  begin
    ...
    Dm.Escrit.Sql.Add('escritorio like ' + Chr(39) + Trim(MaskEdit1.Text) + '%' + Chr(39));
  ...
  begin
    ...
    Dm.Escrit.Sql.Add('agencia like ' + Chr(39) + Trim(MaskEdit1.Text) + '%' + Chr(39));
    Dm.Escrit.Sql.Add('ORDER BY agencia');
  end;
