...
Procedure TF_BxRet.BuscaTextoCombo(Sender : TObject);
var
  x : Integer;
begin
  x := 0;
...
Procedure TF_BxRet.BaixaRetorno(Sender : TObject; NumBaixa : Integer);
var
...
begin
  ...
  Dm.BxRet.Post;
  AtualizaTabela('td_cert', Label4.Caption,
                 (cdata + ',' + csit + ',' + ccod + ',rl' ),
  ...
  else Atualiza_His(DateToStr(Date), TimeToStr(Time), 'T', F_Menu.Label1.Caption, 'Notificação baixada como ' + Ver_TipoBaixaNotificacao(Label5.Caption) + ' em ' + MaskEdit3.Text, Label4.Caption);  
  WpRichText1.Lines.Insert(0, StrBranco(MaskEdit1.Text, 20, 'D') + ' - Destinatário : ' + Busca_NomePessoal(Label4.Caption, 'D'));
  WpRichText1.Refresh;
end;

procedure TF_BxRet.BitBtn8Click(Sender: TObject);
begin
  Close;
end;

procedure TF_BxRet.RadioGroup1Click(Sender: TObject);
begin
...
procedure TF_BxRet.MaskEdit2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then MaskEdit1.SetFocus;
end;

procedure TF_BxRet.ComboBox1Enter(Sender: TObject);
begin
  SendMessage(ComboBox1.handle, CB_SHOWDROPDOWN, Integer(True), 0);
end;

procedure TF_BxRet.ComboBox1Exit(Sender: TObject);
begin
  MaskEdit2.Text := Copy(ComboBox1.Text, 1,5);
end;

procedure TF_BxRet.ComboBox1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then MaskEdit1.SetFocus;
end;

procedure TF_BxRet.FormActivate(Sender: TObject);
begin
...
procedure TF_BxRet.MaskEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
...
begin
  ...
  begin
    ...
    NumRL   := '';
    NumCert := '';
    if (Copy(MaskEdit1.Text, 1, 2) = 'RC') or (Copy(MaskEdit1.Text, 1, 2) = 'RZ')then
    begin
    ...
    Dm.ArqAux.Close;
    Dm.ArqAux.Sql.Clear;
    Dm.ArqAux.Sql.Add('SELECT anotacao, rl, data_prov1, sit_prov1, cod_prov1,');
    Dm.ArqAux.Sql.Add('data_prov2, sit_prov2, cod_prov2,');
    Dm.ArqAux.Sql.Add('data_prov3, sit_prov3, cod_prov3,');
    Dm.ArqAux.Sql.Add('p_auxiliar, protocolo, rlcertid, certcertif');
    Dm.ArqAux.Sql.Add('FROM td');
    Dm.ArqAux.Sql.Add('WHERE');
    Dm.ArqAux.Sql.Add('registro = ' + ItemBusca);
    Dm.ArqAux.Sql.Add('AND ((natureza = 197) or (natureza = 300))');
    Dm.ArqAux.Sql.Add('AND ((cod_prov1 <> 0) or (cod_prov2 <> 0) or (cod_prov3 <> 0))');
    Dm.ArqAux.Open;
    if (Dm.ArqAux.RecordCount <> 0) then
    begin
      arq := '';
    ...
    if (Dm.ArqAux.FieldByName('data_prov1').asDateTime > 0) then
    begin
      Dm.ArqAux1.Close;
      Dm.ArqAux1.Sql.Clear;
      Dm.ArqAux1.Sql.Add('INSERT ' + arq);
      //Dm.ArqAux1.Sql.Add('(data, hora, certificado, rl, situacao, observacao, descricao, baixa)');
      Dm.ArqAux1.Sql.Add('(data, rl, situacao, descricao, baixa)');
      Dm.ArqAux1.Sql.Add('VALUES(');
      Dm.ArqAux1.Sql.Add(Chr(39) + Dm.ArqAux.FieldByName('data_prov1').asString + Chr(39) + ',');
...
//    Dm.Arqaux1.Sql.Add(Chr(39) + 'RC ' + Dm.ArqAux.FieldByName('rl').asString + ' BR' + Chr(39) + ',');
      ...
      if (Dm.ArqAux.FieldByName('cod_prov1').asInteger = 1) then
      begin
        Dm.ArqAux1.Sql.Add(Chr(39) + 'POSITIVA' + Chr(39) + ',');
      end
      else if (Dm.ArqAux.FieldByName('cod_prov1').asInteger = 2) then
      begin
     ...
     // Dm.ArqAux1.Sql.Add(Chr(39) + Trim(Dm.ArqAux.FieldByName('obs_not1').asString) + Chr(39) + ',');
      Dm.ArqAux1.Sql.Add(Chr(39) + Ver_Ocorrencia(Dm.ArqAux.FieldByName('cod_prov1').asString) + Chr(39) + ',');
      Dm.ArqAux1.Sql.Add('1)');      
      Dm.ArqAux1.ExecSQL;
    end;
    //2ª data de notificação
    if (Dm.ArqAux.FieldByName('data_prov2').asDateTime > 0) then
    begin
      Dm.ArqAux1.Close;
      Dm.ArqAux1.Sql.Clear;
      Dm.ArqAux1.Sql.Add('INSERT ' + arq);
      ...
      Dm.ArqAux1.Sql.Add('(data, rl, situacao, descricao, baixa)');
      Dm.ArqAux1.Sql.Add('VALUES(');
      Dm.ArqAux1.Sql.Add(Chr(39) + Dm.ArqAux.FieldByName('data_prov2').asString + Chr(39) + ',');
     // Dm.ArqAux1.Sql.Add(Chr(39) + Dm.ArqAux.FieldByName('hora_not2').asString + Chr(39) + ',');
     // Dm.ArqAux1.Sql.Add(Chr(39) + Dm.ArqAux.FieldByName('anotacao').asString  + Chr(39) + ',');
//    Dm.Arqaux1.Sql.Add(Chr(39) + 'RC ' + Dm.ArqAux.FieldByName('rl').asString + ' BR' + Chr(39) + ',');
      Dm.Arqaux1.Sql.Add(Chr(39) + F_Menu.Label34.Caption + Dm.ArqAux.FieldByName('rl').asString + ' BR' + Chr(39) + ',');
      if (Dm.ArqAux.FieldByName('cod_prov2').asInteger = 1) then
      begin
        Dm.ArqAux1.Sql.Add(Chr(39) + 'POSITIVA' + Chr(39) + ',');
      end
      else if (Dm.ArqAux.FieldByName('cod_prov2').asInteger = 2) then
      begin
        Dm.ArqAux1.Sql.Add(Chr(39) + 'PARCIAL' + Chr(39) + ',');
      end
      else Dm.ArqAux1.Sql.Add(Chr(39) + 'NEGATIVA' + Chr(39) + ',');
      //Dm.ArqAux1.Sql.Add(Chr(39) + Trim(Dm.ArqAux.FieldByName('obs_not2').asString) + Chr(39) + ',');
      Dm.ArqAux1.Sql.Add(Chr(39) + Ver_Ocorrencia(Dm.ArqAux.FieldByName('cod_prov2').asString) + Chr(39) + ',');
      Dm.ArqAux1.Sql.Add('2)');
      Dm.ArqAux1.ExecSQL;
    end;
    //3ª data de notificação
    if (Dm.ArqAux.FieldByName('data_prov3').asDateTime > 0) then
    begin
      Dm.ArqAux1.Close;
      Dm.ArqAux1.Sql.Clear;
      Dm.ArqAux1.Sql.Add('INSERT ' + arq);
      ...
      Dm.ArqAux1.Sql.Add('(data, rl, situacao, descricao, baixa)');
      Dm.ArqAux1.Sql.Add('VALUES(');
      Dm.ArqAux1.Sql.Add(Chr(39) + Dm.ArqAux.FieldByName('data_prov3').asString + Chr(39) + ',');
      //Dm.ArqAux1.Sql.Add(Chr(39) + Dm.ArqAux.FieldByName('hora_not3').asString + Chr(39) + ',');
     // Dm.ArqAux1.Sql.Add(Chr(39) + Dm.ArqAux.FieldByName('anotacao').asString  + Chr(39) + ',');
//    Dm.Arqaux1.Sql.Add(Chr(39) + 'RC ' + Dm.ArqAux.FieldByName('rl').asString + ' BR' + Chr(39) + ',');
      Dm.Arqaux1.Sql.Add(Chr(39) + F_Menu.Label34.Caption + Dm.ArqAux.FieldByName('rl').asString + ' BR' + Chr(39) + ',');
      if (Dm.ArqAux.FieldByName('cod_prov3').asInteger = 1) then
      begin
        Dm.ArqAux1.Sql.Add(Chr(39) + 'POSITIVA' + Chr(39) + ',');
      end
      else if (Dm.ArqAux.FieldByName('cod_prov3').asInteger = 2) then
      begin
        Dm.ArqAux1.Sql.Add(Chr(39) + 'PARCIAL' + Chr(39) + ',');
      end
      else Dm.ArqAux1.Sql.Add(Chr(39) + 'NEGATIVA' + Chr(39) + ',');
     // Dm.ArqAux1.Sql.Add(Chr(39) + Trim(Dm.ArqAux.FieldByName('obs_not3').asString) + Chr(39) + ',');
      Dm.ArqAux1.Sql.Add(Chr(39) + Ver_Ocorrencia(Dm.ArqAux.FieldByName('cod_prov3').asString) + Chr(39) + ',');
      Dm.ArqAux1.Sql.Add('3)');
      Dm.ArqAux1.ExecSQL;
    end;
   { Dm.ArqAux.Close;
    Dm.ArqAux.Sql.Clear;
    Dm.ArqAux.Sql.Add('SELECT p_auxiliar, protocolo, rl, anotacao, rlcertid, certcertif,');
    Dm.ArqAux.Sql.Add('data_prov1, cod_prov1, sit_prov1,');
    Dm.ArqAux.Sql.Add('data_prov2, cod_prov2, sit_prov2,');
    Dm.ArqAux.Sql.Add('data_prov3, cod_prov3, sit_prov3');
    Dm.ArqAux.Sql.Add('FROM td');
    Dm.ArqAux.Sql.Add('WHERE');
    Dm.ArqAux.Sql.Add('registro = ' + ItemBusca);
    ...
    begin
      ...
      begin
        ...
        Dm.ArqAux1.Sql.Add(Chr(39) + ConvData(Dm.ArqAux.FieldByName('data_prov1').asString) + Chr(39) + ',')
        else
        Dm.ArqAux1.Sql.Add(Chr(39) + '' + Chr(39)+ ',');
        if  Dm.ArqAux.FieldByName('data_prov1').asString <> '' then

        if  Dm.ArqAux.FieldByName('data_prov2').asString <> '' then
        Dm.ArqAux1.Sql.Add(Chr(39) + ConvData(Dm.ArqAux.FieldByName('data_prov2').asString) + Chr(39) + ',')
        else
        Dm.ArqAux1.Sql.Add(Chr(39) + '' + Chr(39)+ ',');

        if  Dm.ArqAux.FieldByName('data_prov3').asString <> '' then
        Dm.ArqAux1.Sql.Add(Chr(39) + ConvData(Dm.ArqAux.FieldByName('data_prov3').asString) + Chr(39) + ',')
        else
        Dm.ArqAux1.Sql.Add(Chr(39) + '' + Chr(39)+ ',');
        ...
        Dm.ArqAux1.Sql.Add(Chr(39) + Dm.ArqAux.FieldByName('cod_prov1').asString + Chr(39) + ',');
        Dm.ArqAux1.Sql.Add(Chr(39) + Dm.ArqAux.FieldByName('cod_prov2').asString + Chr(39) + ',');
        Dm.ArqAux1.Sql.Add(Chr(39) + Dm.ArqAux.FieldByName('cod_prov3').asString + Chr(39) + ',');
        Dm.ArqAux1.Sql.Add(Chr(39) + Dm.ArqAux.FieldByName('sit_prov1').asString + Chr(39) + ',');
        Dm.ArqAux1.Sql.Add(Chr(39) + Dm.ArqAux.FieldByName('sit_prov2').asString + Chr(39) + ',');
        Dm.ArqAux1.Sql.Add(Chr(39) + Dm.ArqAux.FieldByName('sit_prov3').asString + Chr(39) + ',');
        if (Dm.ArqAux.FieldByName('cod_prov1').asInteger > 0) then
         Dm.ArqAux1.Sql.Add(Chr(39) + Ver_Ocorrencia(Dm.ArqAux.FieldByName('cod_prov1').asString) + Chr(39) + ',')
        else
         Dm.ArqAux1.Sql.Add(Chr(39) + ''+ Chr(39)+ ',');

        if (Dm.ArqAux.FieldByName('cod_prov2').asInteger > 0) then
         Dm.ArqAux1.Sql.Add(Chr(39) + Ver_Ocorrencia(Dm.ArqAux.FieldByName('cod_prov2').asString) + Chr(39) + ',')
        else
         Dm.ArqAux1.Sql.Add(Chr(39) + ''+ Chr(39)+ ',');

        if (Dm.ArqAux.FieldByName('cod_prov3').asInteger > 0) then
         Dm.ArqAux1.Sql.Add(Chr(39) + Ver_Ocorrencia(Dm.ArqAux.FieldByName('cod_prov3').asString) + Chr(39) + ')')
        else
         Dm.ArqAux1.Sql.Add(Chr(39) + ''+ Chr(39)+')');
...
//  a ser baixado provisoriamente.
    ...
    Dm.BxRet.Sql.Add('data_not3, cod_ir3, sit_not3, hora_not3');
    Dm.BxRet.Sql.Add('FROM td');
    Dm.BxRet.Sql.Add('WHERE');
    Dm.BxRet.Sql.Add('registro = ' + ItemBusca);
    Dm.BxRet.Sql.Add('AND ((natureza = 197)or (natureza = 300))');
    Dm.BxRet.Open;
    ...
    begin
      ...
      begin
        ...
        if (MessageBox(Handle, PChar('ATENÇÃO - ESTE TÍTULO JÁ POSSUI UMA BAIXA - DESEJA REALIZAR NOVA BAIXA ?'), 'ATENÇÃO - BAIXA JÁ ENCONTRADA.', MB_YESNO + MB_ICONQUESTION + MB_DEFBUTTON2) = IdYes) then BaixaRetorno(F_BxRet, 1);
      end
      else
      begin
        // Verificando se já existe uma baixa.
        ...
        begin
          ...
          begin
            ...
            begin
              BaixaRetorno(F_BxRet, 2);
            end;
          end
          else
          begin
            BaixaRetorno(F_BxRet, 1);
          end;
        end;
      end;
    end
...
procedure TF_BxRet.MaskEdit1Exit(Sender: TObject);
begin
  MaskEdit1.Text := Trim(MaskEdit1.Text);
end;

procedure TF_BxRet.MaskEdit2Exit(Sender: TObject);
begin
