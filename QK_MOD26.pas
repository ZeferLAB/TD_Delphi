...
procedure TF_Mod26.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TF_Mod26.QRChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
 ...
 // QrLabel11.Caption := 'CNPJ/CPF:' + Table1.FieldByName('documento').asString;
  ...
  QrLabel14.caption  := Table1.FieldByName('nome').asString + ', RG '+ Table1.FieldByName('documento').asString + ',';
  QrLabel19.caption  := Table1.FieldByName('p_v_mora').asString;
  QrLabel17.caption  := copy(Table1.FieldByName('contrato').asString,1,88);
  QrLabel49.caption  := copy(Table1.FieldByName('contrato').asString,89,200);
  QrLabel18.caption  := formatcurr('R$###,###,##0.00',Table1.FieldByName('vr_total').ascurrency);
  QrLabel26.caption  := formatcurr('R$###,###,##0.00',Table1.FieldByName('vr_venc').ascurrency);
