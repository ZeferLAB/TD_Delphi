...
var
  Qk_RelPro7: TQk_RelPro7;
  x, qtde, ate_3, mais_3, andam     : Integer;

implementation

Uses DMTD, Menu , RelPro7, FuncGeral;

{$R *.DFM}

procedure TQk_RelPro7.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qtde := qtde + 1;
...
procedure TQk_RelPro7.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  x      := 0;
  qtde   := 0;
...
procedure TQk_RelPro7.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin     
  QrLabel3.Caption := '000';  
  qtde := 0;
...
procedure TQk_RelPro7.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
