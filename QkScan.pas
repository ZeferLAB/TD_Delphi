...
procedure TQk_Scan.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
var
  ende : string;
begin
  QrLabel13.Caption  := '';
  ...
  //QrLabel80.Caption  := Dm.Join.FieldByName('endereco').asString + '  Nº ' + Dm.Join.FieldByName('numero').asString +'  '+ Trim(Dm.Join.FieldByName('complem').asString);
...
procedure TQk_Scan.QRChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  ende : String;
begin
